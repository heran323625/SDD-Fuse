...
class MSRS_Dataset(Dataset):
    def __init__(self, dataroot, resolution=256, split='train', data_len=-1):
        ...
        self.vis_path = Util.get_paths_from_images('{}/vi'.format(dataroot))
        self.ir_path = Util.get_paths_from_images('{}/ir'.format(dataroot))
        self.fusion_path = Util.get_paths_from_images('{}/Fusion'.format(dataroot))
