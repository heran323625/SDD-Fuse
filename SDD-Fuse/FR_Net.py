...
class Attention_ROPE(nn.Module):
    def __init__(self, dim, num_heads, bias, max_seq_len=256):
        super(Attention_ROPE, self).__init__()
    ...
    def forward(self, x):
        ...
        b, head, c, s = q.shape
        freqs_cis = precompute_freqs_cis(s, c).to(q.device)
...
class TransformerBlock(nn.Module):
    def __init__(self, dim, num_heads, ffn_expansion_factor, bias, LayerNorm_type):
        ...
        self.attn = Attention_ROPE(dim, num_heads, bias)
...
class Restormer_ROPE(nn.Module):
    def __init__(self,
                 in_channel=3,
                 out_channel=3,
                 dim=36,
        ...
        super(Restormer_ROPE, self).__init__()
        ...
        self.patch_embed_refine = OverlapPatchEmbed(2, dim)
